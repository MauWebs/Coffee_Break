...
// EDIT IMAGE
export const PRODUCT_EDIT_IMAGE_REQUEST = 'PRODUCT_EDIT_IMAGE_REQUEST';
export const PRODUCT_EDIT_IMAGE_SUCCESS = 'PRODUCT_EDIT_IMAGE_SUCCESS';
export const PRODUCT_EDIT_IMAGE_FAIL = 'PRODUCT_EDIT_IMAGE_FAIL';
